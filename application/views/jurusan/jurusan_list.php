...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $jurusan->fakultas_id ?></td>
			<td><?php echo $jurusan->name ?></td>
			<td><?php echo $jurusan->created_at ?></td>
			<td><?php echo $jurusan->updated_at ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('jurusan/read/'.$jurusan->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('jurusan/update/'.$jurusan->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('jurusan/delete/'.$jurusan->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
